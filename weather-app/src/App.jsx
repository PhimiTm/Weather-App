...
function App() {
  ...
  return (
    <div className="min-h-screen flex font-sans">
      <aside className="w-full md:w-1/3 lg:w-1/4 bg-white p-6 shadow-md">
        <Sidebar onWeatherChange={handleWeatherChange} unit={unit} />
      </aside>

      <main className="flex-1 p-6 bg-gradient-to-br from-blue-100 to-indigo-200 overflow-y-auto">
        ...
        {/* 📆 Weekly Forecast */}
        <h2 className="text-2xl font-semibold mb-4">Weekly Forecast</h2>
        <WeeklyForecast weather={weather} unit={unit} />

        {/* ☀️ Today's Highlights */}
        <h2 className="text-2xl font-semibold mt-10 mb-4">Today's Highlights</h2>
